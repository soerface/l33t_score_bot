...
def handle_private_chat(update: Update, context: CallbackContext):
...
def handle_timezone_command(update: Update, context: CallbackContext):
    ...
    if len(context.args) == 0:
        ...
        context.bot.send_message(chat_id=update.message.chat_id, text='Choose your region', reply_markup=reply)
        return
